                        ...
                        {/* <div className='d-flex justify-content-center'>
                            <div className='p-4 bg-light d-flex justify-content-center w-sm-auto'>
                                <div className='row '>
                                    ...
                                    <div className='col'>
                                        <b>Naresh sherma </b><span className='bi-star-fill text-warning'></span>
                                        <div className='CommentsText'>
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, cumque. Commodi quidem eum nisi voluptatum at nobis. Deleniti eveniet aperiam perferendis veniam et? Reiciendis facere quaerat consequatur totam? Dicta, soluta?
                                        </div>
                                    </div>
                                </div>
                            </div>
