        ...
        <div>
            <header>
                ...
                <div className='d-flex justify-content-end'>
                    <span className={`${displayStyleLogin} d-flex login-button btn ms-4`} style={{ backgroundColor: "#F97D3D", borderRadius: "2rem" }}>
                        <span>
                    ...
                    {cookies.user && (
                        <div className="dropdown ms-4">
                            <button className="btn d-flex align-items-center" onClick={toggleDropdown} style={{ backgroundColor: "#F97D3D", borderRadius: "2rem" }}>
                                <span>
                                    <img src={dp} alt="Profile" className="pb-1 rounded-circle" style={{ width: '2rem' }} />
                                </span>
                                <span className="fw-medium text-light ms-2">{cookies.user} <span className='ms-2 bi bi-chevron-down'></span></span>
                            </button>
                            {dropdownVisible && (
                                <div className="dropdown-menu show mt-2">
                                    <div className="dropdown-item d-flex ">
                                        <span  >
                                            <img src={dp} alt="Profile" className="rounded-circle boeder-1 text-center me-2" style={{ width: '40px' }} />
                                        </span>
                                        <span>
                                            <div>
                                    ...
                                    <div className="dropdown-divider"></div>
                                    <div className="bi bi-box-arrow-left dropdown-item text-danger"><span className='ms-1'>Sign Out</span></div>
                                </div>
                            )}
                        </div>
                    )}
