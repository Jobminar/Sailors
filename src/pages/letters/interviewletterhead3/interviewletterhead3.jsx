    ...
    <>

      {
        (user?.interviewoutcome?.status === undefined) ? navigate('/myadmitcard') :
          ...
          //         <div>
          //           <div className="text-center h2 m-3 mb-5">INTERVIEW INVITATION</div>
          //           <div>
          //             <div className="row">
          ...
          //             </div>
          //             <div className="fw-medium my-5">Dear candidate,</div>
          //             <p>
          ...
          //           </div>
          //           <div className="fw-medium my-5">Interview Instructions</div>
          //           <ul>
          ...
          //       <div className="Footer bg-secondary text-light mt-5">
          //         <div>
